...
async function migrateSellers() {
  // Step 1: Get unique seller names and images from products
  ...
  // Step 2: Create or update sellers in Seller table
  for (const { seller, sellerimage } of sellers) {
    if (seller) {
  ...
  // Step 3: Update products to connect to the seller
  ...
  console.log("✅ Sellers migrated and linked successfully.");
}
